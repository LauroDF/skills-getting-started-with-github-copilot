...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["lisa@mergington.edu", "jordan@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["chris@mergington.edu", "sara@mergington.edu"]
    },
    "Science Club": {
        "description": "Perform experiments and explore scientific concepts",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["zach@mergington.edu", "maya@mergington.edu"]
    }
}
